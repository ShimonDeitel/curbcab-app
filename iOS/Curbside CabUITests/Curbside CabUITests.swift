...
final class CurbsideCabUITests: XCTestCase {
    ...
    func testAddEntryFlow() {
        ...
        let field1 = app.textFields["field_pickup"]
    ...
    func testFreeLimitTriggersPaywall() {
        ...
        XCTAssertTrue(app.buttons["paywallPurchaseButton"].waitForExistence(timeout: 2) || app.staticTexts["Curbside Cab Pro"].waitForExistence(timeout: 2))
    }
